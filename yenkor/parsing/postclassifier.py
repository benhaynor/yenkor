...
class TrainedClassifier:
    '''
    A trained classifer.  Can be used to determine if from a driver
    or a passenger, as well as if a post is valid or invalid.
    An invalid post is either spam, or multi trip.  Future iterations
    can try to accomodate round trip journeys. 
    '''
    ...
    def __init__(self,classifierType):
        ...
        dirname = os.path.join(os.path.dirname(__file__),'trainingdata')
